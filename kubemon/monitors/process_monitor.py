...
class ProcessMonitor(BaseMonitor):
    ...
    def __init__(self, container: Container, pid: int):
        ...
        try:
            ...
            LOGGER.warn('pid %s not exist', pid)
    ...
    def __str__(self) -> str:
        ...
        return f'ProcessMonitor_{gethostname()}_{ip}_{self.__container.name}_{self.pid}'
    
    def __repr__(self) -> str:
        return f'<ProcessMonitor - {gethostname()} - {get_host_ip()} - {self.__container.name} - {self.pid}>'
